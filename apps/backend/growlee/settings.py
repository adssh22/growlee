...
STRIPE_SUCCESS_URL = os.getenv('STRIPE_SUCCESS_URL', f'{APP_BASE_URL}/admin/?checkout=stripe_success').strip()
STRIPE_CANCEL_URL = os.getenv('STRIPE_CANCEL_URL', f'{APP_BASE_URL}/admin/checkout/?checkout=stripe_cancel').strip()
...
MIDDLEWARE = [
    ...
    'apps.core.middleware.StaffAdminMfaMiddleware',
...
MEDIA_STORAGE = os.getenv('DJANGO_MEDIA_STORAGE', 'local').strip().lower() or 'local'
MEDIA_URL = '/media/'
